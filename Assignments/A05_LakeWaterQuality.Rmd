...
> TSI computed from chlorophyll is the msot conservative of the metrics, with 56% of teh samples assigned as eutrophic and 20% of the sample assigned as hypereutrophic, compared with 38% and 33% assigned as eutrophic using Secchi depth and total phosphorus, respectively. This may be because...[chlorophyll makes up the majority of reduced clarity and primary productivity is limited by phosphorus]. 
